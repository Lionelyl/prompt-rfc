...
class BERT_BiLSTM_CRF(nn.Module):
    ...
    def init_hidden_chunk_bilstm(self):
        var1 = torch.autograd.Variable(torch.zeros(2, self.batch_size, self.chunk_hidden_dim)).cpu()
        var2 = torch.autograd.Variable(torch.zeros(2, self.batch_size, self.chunk_hidden_dim)).cpu()
        return var1, var2
